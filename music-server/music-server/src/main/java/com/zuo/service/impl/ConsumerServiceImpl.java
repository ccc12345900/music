...
import com.zuo.mapper.ConsumerMapper;
...
import static com.zuo.constant.Constants.SALT;
...
public class ConsumerServiceImpl extends ServiceImpl<ConsumerMapper, Consumer> implements ConsumerService {
    ...
    public R loginStatus(ConsumerRequest consumerRequest, HttpSession session) {
        ...
        if(this.verityPasswd(username,password)){
            ...
            return R.success("登陆成功",consumerMapper.selectList(new QueryWrapper<>(consumer)));
        }else{
